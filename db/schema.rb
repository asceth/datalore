...
ActiveRecord::Schema.define(:version => 20120606014421) do
  ...
  add_index "forum_categories", ["deleted_at"], :name => "index_forum_categories_on_deleted_at"
  ...
  add_index "forum_poll_options", ["deleted_at"], :name => "index_forum_poll_options_on_deleted_at"
  ...
  add_index "forum_polls", ["deleted_at"], :name => "index_forum_polls_on_deleted_at"
